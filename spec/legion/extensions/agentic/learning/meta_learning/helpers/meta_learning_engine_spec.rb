...
RSpec.describe Legion::Extensions::Agentic::Learning::MetaLearning::Helpers::MetaLearningEngine do
  ...
  describe '#create_domain' do
    it 'returns a LearningDomain' do
      expect(ruby_domain).to be_a(Legion::Extensions::Agentic::Learning::MetaLearning::Helpers::LearningDomain)
    end
  ...
  describe '#create_strategy' do
    it 'returns a Strategy' do
      expect(flash_strategy).to be_a(Legion::Extensions::Agentic::Learning::MetaLearning::Helpers::Strategy)
    end
    ...
    it 'returns error when limit reached' do
      stub_const('Legion::Extensions::Agentic::Learning::MetaLearning::Helpers::Constants::MAX_STRATEGIES', 0)
  ...
  describe 'episode cap' do
    it 'does not exceed MAX_EPISODES' do
      stub_const('Legion::Extensions::Agentic::Learning::MetaLearning::Helpers::Constants::MAX_EPISODES', 3)
      d = engine.create_domain(name: 'ruby')
      5.times { engine.record_episode(domain_id: d.id, success: true) }
